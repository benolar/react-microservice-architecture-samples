...
​Overview
This repository contains sanitized extractions from a proprietary production application I recently architected. I am sharing these specific modules to demonstrate non-trivial logic in both React frontend architecture and serverless microservice orchestration.
